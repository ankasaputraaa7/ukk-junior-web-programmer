...
<div class="container mb-5">
    <div class="slip-card p-4" id="slipContent">
        ...
        <!-- HEADER DENGAN TAMPILAN PERIODE PERSIS DI BAWAH SLIP GAJI KARYAWAN -->
        <div class="header-bg text-center mb-4">
            <h4 class="fw-bold mb-1">SLIP GAJI KARYAWAN</h4>
            <small class="opacity-75 fw-medium text-uppercase tracking-wide">PERIODE: <?php echo htmlspecialchars($periode); ?></small>
        </div>
